...
class YOLO(object):
    _defaults = {
        "model_path": 'trained_weights_no_vision.h5',
...
if __name__ == "__main__":
    yolo = YOLO()
    #image = 'zebra.jpg'
    #image = 'sort_img/zcmlog-2020-05-01.0000__1/img/SL_18245000000.png'
    image = 'sort_img/zcmlog-2020-05-01.0022__1/img/LR_20864000000.png'

    r_image, v_boxes = yolo.detect_img(image)
    print(v_boxes)
