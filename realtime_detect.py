...
monitor = {"top": 40, "left": 0, "width": 960, "height": 1000}
...
class YOLO(object):
    _defaults = {
        ...
        #"model_path": 'trained_weights_final.h5', #работает почти отлично
        #"model_path": 'trained_weights_no_vision.h5', #работает отлично
        "model_path": 'trained_weights_YOLO.h5', #работает на 6 классов
